# Elona+ Custom-GX 2.28

*\~Believe in Jure and hold a determination to mince.\~*

Elona+ Custom-GX is a new variant of Elona+ based on Elona+ Custom-G, updated with the changes in Elona+ up to version 2.28.
...
1. Download Elona+ 2.28 from [here](https://mega.nz/file/hG9mjKzY#ocmhlBmFGzc1lEfcLdV2k97GPoafKoVtw6snmhz6Few). Extract it to `elonaplus2.28`.
2. Extract the contents of Custom-GX's archive to the `elonaplus2.28` folder, overwriting all existing files.
...
1. Follow the installation instructions above. Rename the `elonaplus2.28` folder to `2.05-custom-gx` and move it to the `assets/` folder of this repository.
