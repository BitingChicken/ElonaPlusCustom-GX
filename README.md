# Elona+ Custom-GX 2.30

*\~Believe in Jure and hold a determination to mince.\~*

Elona+ Custom-GX is a new variant of Elona+ based on Elona+ Custom-G, updated with the changes in Elona+ up to version 2.30.
...
1. Download Elona+ 2.30 from [here](https://mega.nz/file/4KVjHBCD#3VOIeuXVHCpYcjUvBdmmTCi0z1bI19JP6j83_grkPfg). Extract it to `elonaplus2.30`.
2. Extract the contents of Custom-GX's archive to the `elonaplus2.30` folder, overwriting all existing files.
...
1. Follow the installation instructions above. Rename the `elonaplus2.30` folder to `2.05-custom-gx` and move it to the `assets/` folder of this repository.
